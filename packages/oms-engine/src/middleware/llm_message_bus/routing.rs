...
use crate::middleware::llm_message_bus::types::{
    LlmProvider, LlmRoute, RouteHealth, RoutingCondition,
};
        ...
        routes.insert(
            ...
            vec![
                ...
                LlmRoute {
                    ...
                    weight: 0.3,
                    conditions: vec![RoutingCondition::ConvictionRange { min: 0.8, max: 1.0 }],
                    health_status: RouteHealth::Healthy,
                },
                LlmRoute {
                    ...
                    weight: 0.1,
                    conditions: vec![RoutingCondition::ConvictionRange { min: 0.9, max: 1.0 }],
                    health_status: RouteHealth::Healthy,
                },
            ],
        );
